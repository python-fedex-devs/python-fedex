...
from fedex.services.rate_service import FedexInternationalRateServiceRequest
...
rate_request = FedexInternationalRateServiceRequest(CONFIG_OBJ, customer_transaction_id=customer_transaction_id)
...
rate_request.RequestedShipment.Shipper.Address.City = 'Herndon'
rate_request.RequestedShipment.Shipper.Address.StateOrProvinceCode = 'VA'
rate_request.RequestedShipment.Shipper.Address.PostalCode = '20171'
...
# Recipient address
rate_request.RequestedShipment.Recipient.Address.StreetLines = ['Address Line 1']
rate_request.RequestedShipment.Recipient.Address.City = 'Kyiv'
rate_request.RequestedShipment.Recipient.Address.StateOrProvinceCode = ''
rate_request.RequestedShipment.Recipient.Address.PostalCode = '04070'
rate_request.RequestedShipment.Recipient.Address.CountryCode = 'UA'
...
# International Shipment attributes

rate_request.ReturnTransitAndCommit = True
rate_request.RequestedShipment.ServiceType = 'INTERNATIONAL_PRIORITY'
rate_request.RequestedShipment.RateRequestTypes = 'LIST'

rate_request.RequestedShipment.CustomsClearanceDetail.CustomsValue.Amount = 100
rate_request.RequestedShipment.CustomsClearanceDetail.CustomsValue.Currency = "USD"

rate_request.RequestedShipment.CustomsClearanceDetail.DutiesPayment.Payor.ResponsibleParty.AccountNumber = CONFIG_OBJ.account_number
