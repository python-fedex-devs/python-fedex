...
shipment.RequestedShipment.Recipient.Contact.PhoneNumber = '00380445020911'

# Recipient address
shipment.RequestedShipment.Recipient.Address.StreetLines = ['4, Horyva St.']
...
# shipment.RequestedShipment.CustomsClearanceDetail.CommercialInvoice.Purpose = "GIFT"
