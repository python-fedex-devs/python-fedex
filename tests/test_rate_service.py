...
def test_rate_international(self):
    ...
    rate.RequestedShipment.Recipient.Address.StateOrProvinceCode = ''
    rate.RequestedShipment.Recipient.Address.PostalCode = '04070'
    rate.RequestedShipment.Recipient.Address.CountryCode = 'UA'

    rate.ReturnTransitAndCommit = True
    rate.RequestedShipment.ServiceType = 'INTERNATIONAL_PRIORITY'
    rate.RequestedShipment.RateRequestTypes = 'LIST'

    rate.RequestedShipment.CustomsClearanceDetail.CustomsValue.Amount = 100
    rate.RequestedShipment.CustomsClearanceDetail.CustomsValue.Currency = "USD"

    rate.RequestedShipment.CustomsClearanceDetail.DutiesPayment.Payor.ResponsibleParty.AccountNumber = CONFIG_OBJ.account_number
    rate.RequestedShipment.CustomsClearanceDetail.DutiesPayment.PaymentType = 'SENDER'
